...
describe('BasicLayout', () => {
  ...
  it('should render the Hacker News banner component when the correct prop is passed', () => {
  ...
  it('should render the error component when the correct prop is passed', () => {
  ...
  it('should render the spinner component when the correct prop is passed', () => {
